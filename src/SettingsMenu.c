...
static void window_load(Window *window) {
	...
	text_layer_set_text(s_menu_title_label, "Settings");
	...
	s_sunday_label = text_layer_create(GRect(0, 43, 144, 30)); 
	text_layer_set_text(s_sunday_label, "Sunday");
  ...
  s_weekday_label = text_layer_create(GRect(0, 85, 144, 30));
	text_layer_set_text(s_weekday_label, "Weekdays");
	...
	s_saturday_label = text_layer_create(GRect(0, 128, 144, 30));
	text_layer_set_text(s_saturday_label, "Saturday");
